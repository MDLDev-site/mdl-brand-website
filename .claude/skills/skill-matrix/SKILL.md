...
- Astro site build → Astro Specialist
- Astro performance audit → Astro Specialist + Performance Engineer
- Astro i18n/multi-locale → Astro Specialist + Localization & i18n Engineer
- Astro deployment pipeline → Astro Specialist + DevOps/IaC Specialist
...
## MDL Astro Quick Reference

| Scenario | Primary Skill | Supporting Skills |
|---|---|---|
| New Astro site setup | Astro Specialist | DevOps/IaC Specialist |
| Astro component architecture | Astro Specialist | Frontend/UX Specialist |
| Islands hydration strategy | Astro Specialist | Performance Engineer |
| Content collections design | Astro Specialist | Technical Writer |
| Astro SSR/API routes | Astro Specialist | Backend/Distributed Systems Engineer, Security Sentinel |
| Astro i18n routing | Astro Specialist | Localization & i18n Engineer |
| Astro performance audit | Astro Specialist | Performance Engineer |
| Astro deployment & CI/CD | Astro Specialist | DevOps/IaC Specialist |
| Astro security (CSP, env vars) | Astro Specialist | Security Sentinel |
| Astro SEO & sitemap | Astro Specialist | Technical Writer |

## MDL Standards Quick Reference

| Scenario | Skill |
|----------|-------|
| Writing a commit message | `git-workflow` |
| Creating a branch | `git-workflow` |
| Writing a PR description | `git-workflow` |
| Updating CHANGELOG.md | `changelog-standards` |
| Releasing a version | `changelog-standards` → `git-workflow` |
| Handling API errors | `error-handling-standards` |
| Designing error responses | `error-handling-standards` → `api-platform-engineer` |
| Logging patterns | `error-handling-standards` → `observability-engineer` |
| Retry logic | `error-handling-standards` |
| Security review | `security-standards` → `security-sentinel` |
| Input validation | `security-standards` |
| Secrets management | `security-standards` |
| PCI / payment security | `security-standards` → `security-sentinel` |
| Optimising images | `performance-standards` |
| Core Web Vitals audit | `performance-standards` → `performance-engineer` |
| Lambda cold starts | `performance-standards` → `performance-engineer` |
| Bundle size analysis | `performance-standards` → `performance-engineer` |
| Cache strategy | `performance-standards` |
